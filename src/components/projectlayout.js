...
render(){
    return(
        <svg className = {this.props.shape + ' mask'} viewBox="0 0 426 426" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M414 207C414 321.323 321.323 414 207 414C92.6771 414 0 321.323 0 207C0 92.6771 92.6771 0 207 0C321.323 0 414 92.6771 414 207Z" fill={'url(#pattern' + this.props.num + ')'}/>
            <path id = 'loadingOutline' d="M395.5 207C395.5 311.106 311.106 395.5 207 395.5C102.894 395.5 18.5 311.106 18.5 207C18.5 102.894 102.894 18.5 207 18.5C311.106 18.5 395.5 102.894 395.5 207Z" stroke="white" stroke-width="3"/>
              </>
            }
            }
